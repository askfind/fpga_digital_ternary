...
//
// Description: Операция инверсия трита. Мнемоника AND_TE.
//
...
always @(*) begin
    case ({a, b})
        4'b0101: c = 2'b01; // a=1, b=1 -> c=1
        4'b0100: c = 2'b01; // a=1, b=0 -> c=1
        4'b0110: c = 2'b01; // a=1, b=2 -> c=1
        4'b0001: c = 2'b01; // a=0, b=1 -> c=1
        4'b0000: c = 2'b00; // a=0, b=0 -> c=0
        4'b0010: c = 2'b00; // a=0, b=2 -> c=0
        4'b1001: c = 2'b01; // a=2, b=1 -> c=1
        4'b1000: c = 2'b00; // a=2, b=0 -> c=0
        4'b1010: c = 2'b10; // a=2, b=2 -> c=2
